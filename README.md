...
**欢迎使用这个主题，使用时请保留 footer 上的模板主题来源。** Theme designed by [HyG](https://github.com/abaojin).
...
若安装了 Foxit 福昕pdf阅读器可能会占用4000端口，关闭 Foxit服务 或切换 jekyll 端口即可解决。详情见文章：[对这个 jekyll 博客主题的改版和重构](http://abaojin.github.io/2016/03/12/jekyll-theme-version-2.0/)
...
* `[^]` 修复标签云算法中被除数为零的 bug。[#26](https://github.com/abaojin/abaojin.github.io/issues/26), [#28](https://github.com/abaojin/abaojin.github.io/issues/28), [#30](https://github.com/abaojin/abaojin.github.io/issues/30)
